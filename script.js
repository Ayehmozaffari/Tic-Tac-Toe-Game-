...
TicTacToe.prototype.paint=function(grid_size){
    ...
    var html=' <table id="scoreboard" align="center">';
    ...
    self.columns=self.placeholder.getElementByTagName("td");
    for(i=0;i<this.columns.lenght;i++){
...
TicTacToe.prototype.mark=function(column){
    ...
    }else if(this.marks.count=== this.columns.lenght){
        this.callback("draw");
    }
};
